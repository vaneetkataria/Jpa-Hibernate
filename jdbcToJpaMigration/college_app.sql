...
(`id`,`name`,`address`,`birth_date_time`,`birth_date_time_zone_offset`,`created_date`,`day_off_time`,`day_start_time`,`father_name`,`mother_name`,`photo`,`monthly_salary`,`updated_date`,`version`, `id_proof_id`)
